      ...
      <div className="min-h-screen bg-background text-foreground">
        ...
        <motion.section initial="hidden" animate="visible" className="relative overflow-hidden">
          <div className="absolute inset-0">
            <img src={heroImg} alt="Peintre en bâtiment au travail" className="h-full w-full object-cover opacity-20" loading="eager" />
              ...
              <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }}>
                <Card className="border-accent/20 bg-accent/5 overflow-hidden">
                  ...
                  <CardContent className="p-6 space-y-5">
                    ...
                    <motion.div custom={3} variants={fadeUp}><Button asChild className="w-full gap-2" size="lg"><Link to="/signup-light?rome=F1502">Commencer mon évaluation de conformité <ArrowRight className="h-4 w-4" /></Link></Button></motion.div>
                  </CardContent>
                </Card>
              </motion.div>
