...
import heroImg from "@/assets/metier-peintre-batiment.jpg?format=webp";
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} className="mt-12">
            <motion.div custom={0} variants={fadeUp}>
              <Card className="border-accent/20 bg-accent/5"><CardContent className="p-6 text-center space-y-4">
                ...
                <Button asChild size="lg" className="gap-2"><Link to="/signup-light?rome=F1502">Vérifier mon éligibilité gratuitement <ArrowRight className="h-4 w-4" /></Link></Button>
              </CardContent></Card>
            </motion.div>
          </motion.div>
