...
import heroImg from "@/assets/metier-infirmier.jpg?format=webp";
      ...
      <div className="min-h-screen bg-background text-foreground">
        ...
        <motion.section initial="hidden" animate="visible" className="relative overflow-hidden">
          <div className="absolute inset-0">
            <img src={heroImg} alt="Infirmier africain souriant intégré dans une équipe soignante multiculturelle en France" className="h-full w-full object-cover opacity-20" loading="eager" />
                ...
                <Card className="border-accent/20 bg-accent/5 overflow-hidden">
                  ...
                  <CardContent className="p-6 space-y-5">
                    ...
                    <motion.div custom={2} variants={fadeUp}>
                      <p className="text-sm text-muted-foreground leading-relaxed italic">Avec ALTIS, vous arrivez en France prêt à démarrer rapidement, une fois les éventuelles validations ou formations réalisées par l'employeur.</p>
                    </motion.div>
                    <motion.div custom={3} variants={fadeUp}>
                      <Card className="border-accent/30 bg-accent/5 mb-4">
                        <CardContent className="p-4">
                          <p className="text-sm font-medium text-accent leading-relaxed">🩺 Votre vocation de soigner transcende les frontières. En France, des milliers de patients attendent des professionnels comme vous — dévoués, compétents et humains. Vous avez le pouvoir de changer des vies, ici aussi.</p>
                        </CardContent>
                      </Card>
                    </motion.div>
                    <motion.div custom={4} variants={fadeUp}>
                      <Button asChild className="w-full gap-2" size="lg">
                        <Link to="/signup-light?rome=M1805">Vérifier mon éligibilité et commencer mon parcours <ArrowRight className="h-4 w-4" /></Link>
                      </Button>
                    </motion.div>
                  </CardContent>
                </Card>
            ...
            <motion.div custom={0} variants={fadeUp}>
              <Card className="border-accent/20 bg-accent/5">
                <CardContent className="p-6 text-center space-y-4">
                  ...
                  <Button asChild size="lg" className="gap-2"><Link to="/signup-light?rome=M1805">Vérifier mon éligibilité gratuitement <ArrowRight className="h-4 w-4" /></Link></Button>
                </CardContent>
              </Card>
            </motion.div>
          </motion.div>
