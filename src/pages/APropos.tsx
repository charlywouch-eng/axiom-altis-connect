        ...
        <div className="mx-auto max-w-6xl px-5 md:px-10">
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-40px" }} className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              { trend: "Plateformes généralistes du marché", direction: "down" as const, impact: "Vérification limitée", detail: "Les plateformes généralistes proposent un large volume de candidatures, mais offrent souvent une vérification limitée des compétences et une conformité moindre aux exigences réglementaires françaises. AXIOM & ALTIS se positionne comme une infrastructure premium spécialisée, alliant certification officielle, conformité rigoureuse et accompagnement physique complet.", axiom: "Infrastructure premium certifiée" },
