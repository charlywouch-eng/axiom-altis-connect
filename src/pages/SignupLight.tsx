                ...
                <div className="p-6 sm:p-8">
                  ...
                  <motion.a
                    href={`https://wa.me/?text=${encodeURIComponent(
                      `🚀 Mon score AXIOM Talents : ${score}% de compatibilité pour travailler en France en ${selectedSecteur?.label?.replace(/^.+?\s/, "") ?? "mon secteur"} !\n\n✅ Métier en tension · Matching ROME certifié\n📊 Faites votre test gratuit → https://axiom-talents.com/signup-light`
                    )}`}
                    target="_blank"
                    ...
                    className="mt-5 flex items-center gap-3 w-full p-3.5 rounded-2xl cursor-pointer transition-all hover:scale-[1.01] active:scale-[0.98] bg-[#25D366]/10 border border-[#25D366]/25 hover:bg-[#25D366]/15"
                  >
                    <div className="h-10 w-10 rounded-xl flex items-center justify-center shrink-0 bg-[#25D366]/20">
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="text-sm font-bold text-[#25D366]">
                        Partagez votre score {score}% sur WhatsApp
                      </p>
                      <p className="text-[11px] mt-0.5 text-[#25D366]/60">
                        +30 % visibilité recruteurs · Boostez votre profil
                      </p>
                    </div>
                    <ArrowRight className="h-4 w-4 shrink-0 text-[#25D366]/60" />
                  </motion.a>
                </div>
              </div>
