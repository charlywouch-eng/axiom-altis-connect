  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Demandez un devis personnalisé pour recruter des talents qualifiés avec le Pack ALTIS : formalités visa de travail (procédure ANEF), accueil aéroport, logement meublé 1 mois et accompagnement administratif."
        />
      </Helmet>
            ...
            <motion.div initial="hidden" animate="visible">
              ...
              <motion.div custom={0} variants={fadeUp} className="text-center mb-10">
                ...
                <p className="mt-2 text-sm text-muted-foreground max-w-md mx-auto">
                  Pack ALTIS — formalités visa de travail (procédure ANEF) + accueil aéroport + logement meublé 1 mois + accompagnement administratif — à partir de 2 450 €/talent.
                </p>
              </motion.div>
