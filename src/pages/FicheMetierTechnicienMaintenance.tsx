...
import {
  ...
  MapPin, Euro, Clock, Zap, Plane, Home, Globe,
...
import heroImg from "@/assets/metier-technicien-maintenance.jpg?format=webp";
              ...
              <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }}>
                <Card className="border-accent/20 bg-accent/5 overflow-hidden">
                  ...
                  <CardContent className="p-6 space-y-5">
                    ...
                    <motion.div custom={4} variants={fadeUp}><Button asChild className="w-full gap-2" size="lg"><Link to="/signup-light?rome=I1308">Vérifier mon éligibilité et commencer mon parcours <ArrowRight className="h-4 w-4" /></Link></Button></motion.div>
                  </CardContent>
                </Card>
              </motion.div>
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} className="mt-12">
            <motion.div custom={0} variants={fadeUp}>
              <Card className="border-accent/20 bg-accent/5"><CardContent className="p-6 text-center space-y-4">
                ...
                <Button asChild size="lg" className="gap-2"><Link to="/signup-light?rome=I1308">Vérifier mon éligibilité gratuitement <ArrowRight className="h-4 w-4" /></Link></Button>
              </CardContent></Card>
            </motion.div>
          </motion.div>
