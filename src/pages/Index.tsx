...
const ENTREPRISE_CARDS = [
  {
    ...
    desc: "Chaque candidat est certifié conforme aux exigences françaises avant d'être présenté. Zéro mauvaise surprise, zéro risque juridique.",
    badge: "Certifié",
    badgeColor: "bg-accent/15 text-accent border-accent/25",
    iconBg: "bg-accent/10",
    iconColor: "text-accent",
    bullets: [
      "Diplômes apostillés par le MINREX",
      "Vérification d'identité biométrique",
      "Antécédents professionnels validés",
      "Casier judiciaire vérifié pays d'origine",
      "Attestation médicale d'aptitude incluse",
    ],
  },
  {
    icon: BarChart3,
    title: "Conformité et précision IA",
    desc: "Matching IA prédictif multi-critères + conformité rigoureuse aux normes françaises. 98 % de rétention à 12 mois garanti.",
    badge: "Premium",
    badgeColor: "bg-primary/15 text-primary border-primary/25",
    iconBg: "bg-primary/10",
    iconColor: "text-primary",
    bullets: [
      ...
      "Score conformité ROME vérifié 0-100 %",
      "Analyse compétences × offre en temps réel",
      "Réduction risque onboarding de −80 %",
      "Tableau de bord recruteur avec shortlist",
    ],
  },
  {
    icon: HeartHandshake,
    title: "Service ALTIS complet",
    desc: "De la sélection à l'intégration opérationnelle jour 1 : visa, logement, transport, formation, accompagnement RH. Forfait 2 450 € tout compris.",
    badge: "2 450 €",
    badgeColor: "bg-tension/15 text-tension border-tension/25",
    iconBg: "bg-tension/10",
    iconColor: "text-tension",
    bullets: [
      "Procédure visa ANEF intégralement gérée",
      "Accueil aéroport + transfert logement",
      "Logement meublé garanti 1er mois",
      "Formation d'intégration culturelle FR",
      "Interlocuteur unique dédié entreprise",
    ],
  },
];
         ...
         { text: "Pilote", label: "Sourcing SAP domicile", icon: Users },
              ...
              return (
                <motion.div key={stat.label} custom={i} variants={scaleIn} className="group bg-card/98 backdrop-blur-sm px-5 py-8 text-center transition-all duration-300 hover:bg-accent/5">
                  ...
                  <p className="text-3xl font-bold font-display tracking-tight text-foreground">{stat.text}</p>
