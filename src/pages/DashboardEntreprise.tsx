                ...
                <CardContent>
                  <div className="grid grid-cols-2 sm:grid-cols-3 xl:grid-cols-6 gap-3">
                    {[
                      ...
                      { step: 5, icon: Plane, label: "ALTIS activation", desc: "Formalités visa de travail (ANEF) + accueil aéroport + logement meublé", color: "text-[hsl(189,94%,43%)]", bg: "bg-accent/10 border-accent/25" },
                      ...
                      <TooltipProvider>
                        <TableBody>
                          {[
                            ...
                            { name: "Pack ALTIS", price: "2 450 €/talent", profiles: "Par talent", features: "Formalités visa de travail (procédure ANEF) + billet A/R + accueil aéroport + logement meublé 1 mois + accompagnement administratif", cta: "En savoir +", highlight: false, badge: "Pack complet", tooltip: "2 450 €/talent – formalités visa de travail (procédure ANEF) + billet A/R + accueil aéroport + logement meublé 1 mois + accompagnement administratif (réduction risque onboarding 80 %)" },
