                      ...
                      <TooltipProvider>
                        <TableBody>
                          {[
                            ...
                            { name: "Pack ALTIS", price: "2 450 €/talent", profiles: "Par talent", features: "Formalités visa de travail (procédure ANEF) + accueil aéroport + logement meublé 1 mois + accompagnement administratif", cta: "En savoir +", highlight: false, badge: "Pack complet", tooltip: "2 450 €/talent – formalités visa de travail (procédure ANEF) + accueil aéroport + logement meublé 1 mois + accompagnement administratif (réduction risque onboarding 80 %)" },
