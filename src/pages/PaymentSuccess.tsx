...
export default function PaymentSuccess() {
  ...
  const perks = [
    ...
    { icon: Globe,     text: "Parcours ALTIS : formalités visa de travail (procédure ANEF) + billet A/R + accueil aéroport + logement meublé 1 mois + accompagnement administratif" },
