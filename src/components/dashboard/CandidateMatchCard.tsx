            ...
            <div className="mt-4 flex gap-2">
              <Tooltip>
                ...
                <TooltipContent side="bottom" className="max-w-xs text-xs">
                  ...
                  <p>+5% fee — formalités visa de travail (procédure ANEF), accueil aéroport, logement meublé, accompagnement administratif. Forfait facturé entreprise, zéro gestion RH mobilité.</p>
                </TooltipContent>
              </Tooltip>
              <Button
                size="sm"
