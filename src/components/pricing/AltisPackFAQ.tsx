...
const FAQ_ITEMS = [
  {
    ...
    answer:
      "Le Pack ALTIS couvre 4 services clés : formalités visa de travail – procédure ANEF (nous vous accompagnons dans toutes les démarches, seules les autorités françaises ANEF + Préfecture étant habilitées à délivrer un visa de travail, Code CESEDA – Articles L.313-10 et R.313-10), accueil & assistance à l'aéroport, logement meublé pendant 1 mois dans une résidence partenaire, et accompagnement administratif complet (préfecture, sécurité sociale, ouverture de compte).",
  },
  {
    icon: Clock,
    ...
    >
      ...
      <div className="mb-8 text-center">
        ...
        <p className="mx-auto mt-2 max-w-lg text-sm text-muted-foreground">
          Formalités visa de travail (procédure ANEF) + accueil aéroport + logement meublé 1 mois + accompagnement administratif — 2 450 €/talent.
        </p>
      </div>
