    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Section style={signature}>
          ...
          <Text style={sigLinks}>
            <Link href="https://axiom-talents.com" style={sigLink}>axiom-talents.com</Link>
            {' · '}
            <Link href="mailto:support@axiom-talents.com" style={sigLink}>support@axiom-talents.com</Link>
          </Text>
        </Section>
