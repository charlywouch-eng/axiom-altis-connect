...
const EMAIL_SUBJECTS: Record<string, string> = {
  signup: 'Confirmez votre email – AXIOM × ALTIS',
  invite: 'Vous êtes invité(e) – AXIOM × ALTIS',
  magiclink: 'Votre lien de connexion – AXIOM × ALTIS',
  recovery: 'Réinitialisez votre mot de passe – AXIOM × ALTIS',
  email_change: "Confirmez votre changement d'email – AXIOM × ALTIS",
  reauthentication: 'Votre code de vérification – AXIOM × ALTIS',
}
...
// Configuration
const SITE_NAME = "axiom-altis-connect"
const SENDER_DOMAIN = "notify.axiom-talents.com"
const ROOT_DOMAIN = "axiom-talents.com"
const FROM_DOMAIN = "axiom-talents.com" // Domain shown in From address (may be root or sender subdomain)
...
const SAMPLE_PROJECT_URL = "https://axiom-altis-connect.lovable.app"
