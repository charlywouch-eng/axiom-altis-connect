          ...
          <td style="padding:36px 40px;">
            ...
            <table style="width:100%;border-collapse:collapse;margin:0 0 24px;border-radius:8px;overflow:hidden;border:1px solid #e2e8f0;">
              ...
              <tr>
                ...
                <td style="padding:10px 16px;color:#475569;font-size:14px;">Formalités visa de travail (procédure ANEF) + accueil aéroport + logement meublé 1 mois + accompagnement administratif</td>
              </tr>
            </table>
